...
package genewarrior.IO;


import java.io.*;
import java.util.*;
import genewarrior.*;
import genewarrior.sequenceHandling.*;
...
//http://www.ncbi.nlm.nih.gov/Sitemap/samplerecord.html#MoleculeTypeB
     ...
     private void addLocusInformation(String str)
    {
        ...
        if (!str.substring(64,67).trim().isEmpty())
        {
            ...
            String division = div;
            if (div.toLowerCase().equals("pri")) division = "Primate Sequence";
            else if (div.toLowerCase().equals("rod")) division = "Rodent Sequence";
            else if (div.toLowerCase().equals("mam")) division = "Other Mammalian Sequence (neither Primate nor Rodent)";
            else if (div.toLowerCase().equals("vrt")) division = "Other Vertebrate Sequence (not Mammalian)";
            else if (div.toLowerCase().equals("inv")) division = "Invertebrate Sequence";
            else if (div.toLowerCase().equals("pln")) division = "Plant, Fungal, and Algal Sequence";
            else if (div.toLowerCase().equals("bct")) division = "Bacterial Sequence";
            else if (div.toLowerCase().equals("vrl")) division = "Viral Sequence";
            else if (div.toLowerCase().equals("phg")) division = "Bacteriophage Sequence";
            else if (div.toLowerCase().equals("syn")) division = "Synthetic Sequence";
            else if (div.toLowerCase().equals("una")) division = "Unannotated Sequence";
            else if (div.toLowerCase().equals("est")) division = "EST (expressed sequence tags) Sequence";
            else if (div.toLowerCase().equals("pat")) division = "Patent Sequence";
            else if (div.toLowerCase().equals("sts")) division = "STS (sequence tagged sites) Sequence";
            else if (div.toLowerCase().equals("gss")) division = "GS (genome survey) Sequence";
            else if (div.toLowerCase().equals("htg")) division = "HTG (high-throughput) Sequence";
            else if (div.toLowerCase().equals("htc")) division = "HTC (unfinished high-throughput cDNA) Sequence";
            else if (div.toLowerCase().equals("env")) division = "Environmental Sampling Sequence";
    ...
    private void addFeature(Object[] str)
    {
        ...
        String[] name = new String[2]; name[0] = ""; name[1]="";
        Position position;
    ...
    //Feature labels
        for (int i=1;i<str.length;i++)
        {
            ...
            if (isProteinProduct)
            {
                ...
                else if (tokens[0].toLowerCase().equals("codon_start"))
                {
                    try
                    {
                ...
                else if (tokens[0].toLowerCase().equals("transl_table"))
                {
                    try
                    {
                ...
                else if (tokens[0].toLowerCase().equals("protein_id"))
                    protein_id=tokens[1];
                else if (tokens[0].toLowerCase().equals("translation"))
                    ;
                else if (tokens[0].toLowerCase().equals("note"))
                {
    ...
    public genbankRead(File f) throws FileNotFoundException, IOException
    {
