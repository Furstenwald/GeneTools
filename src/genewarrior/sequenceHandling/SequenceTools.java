...
import genewarrior.alignment.Alignment;
import genewarrior.alignment.AlignmentTools;
import genewarrior.alignment.SubstitutionMatricesDNA;
...
public class SequenceTools {
    ...
    static public int[] findStartCodon(SequenceDNA seq, int TranslationTable)
    {
        ...
        {
            matchPos[k] = (int)matchPosition.get(k);
        }
 ...
 */
    ...
    static public double getGCcontent(SequenceDNA seq)
    {
        ...
        int GCcount = count[(int)Nucleotide._G]+count[(int)Nucleotide._C]+count[(int)Nucleotide._S];

        return (double)GCcount/(double)(seq.getLength()-count[(int)Nucleotide.__]);
    }
